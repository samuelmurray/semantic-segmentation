...
train_names = training_images_small[0:how_many]
train_labels = training_labels_small[0:how_many]
val_names = validation_images_small[0:10]
val_labels = validation_labels_small[0:10]
